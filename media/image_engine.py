...
class ImageGenerator:
    ...
    def build_prompt(self,article):
        ...
        return self._clean(
            ...
            f"Create an original, realistic, documentary-style visual scene inspired by this verified news story. "
            f"Visual subject: {title}. "
            f"Topic: {topic}. "
            f"Context for visual interpretation only: {summary}. "
            f"Location: {location}. "
            f"Story type: {style}. "
            f"Use sophisticated editorial photography, realistic lighting, natural details, strong composition, "
            f"credible visual storytelling and a polished newsroom aesthetic. "
            f"IMPORTANT: The supplied story information is ONLY visual guidance and MUST NOT appear as text in the image. "
            f"DO NOT GENERATE ANY TEXT OR WRITING. "
            f"No words, letters, numbers, headlines, captions, subtitles, newspaper text, magazine text, "
            f"documents, articles, paragraphs, books, signs, labels, logos, watermarks, typography, "
            f"website interfaces, computer text, phone text, charts with labels, or readable writing. "
            f"If screens, phones, signs, papers, or documents appear naturally in the scene, keep their surfaces "
            f"blank, abstract, blurred, or completely unreadable. "
            f"The final image must contain VISUAL STORYTELLING ONLY and ZERO TYPOGRAPHY. "
            f"No fake evidence, fake documents, misleading proof, graphic content, or sensationalized imagery."
        )
