...
class ImageGenerator:
    ...
    def build_prompt(self,article):
        ...
        return self._clean(
            f"Create a premium editorial news photograph in a realistic documentary style. "
            f"Create an original, non-deceptive visual scene representing this verified news story. "
            f"Visual subject: {title}. "
            f"Topic: {topic}. "
            f"Context for visual interpretation only: {summary}. "
            f"Location: {location}. "
            f"Story type: {style}. "
            f"Use cinematic professional news photography, natural lighting, realistic people and environments, "
            f"strong composition, authentic details, and a sophisticated international newsroom aesthetic. "
            f"The image is for a premium English-language news website. "
            f"IMPORTANT: The image must contain NO TEXT whatsoever. "
            f"Do not generate words, letters, numbers, headlines, captions, subtitles, typography, "
            f"newspaper pages, magazine pages, books, documents, articles, website interfaces, "
            f"text-filled computer screens, signs, labels, logos, watermarks, charts with labels, "
            f"symbols resembling writing, or any readable language. "
            f"Do not depict a newspaper or document containing text. "
            f"Show only the visual story. "
