...
class JournalistAIClient:
    ...
    def chat(self, messages: List[Dict[str, str]], temperature: float = 0.45, max_tokens: int = 6000, enable_thinking: bool = False) -> str:
        return self.client.chat(messages, temperature, max_tokens, enable_thinking=False)
